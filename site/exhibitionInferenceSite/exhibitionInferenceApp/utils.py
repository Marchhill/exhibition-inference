...
def writeReading(x, y, z, t, session, quality):
	...
	models.Reading(x=x, y=y, z=z, t=parse_datetime(t), session=session, quality=quality)
...
def getSession(deviceId, timeReading):
	...
	s = models.Session(device=deviceId, startTime=timeReading, endTime=timeReading)
	return 69